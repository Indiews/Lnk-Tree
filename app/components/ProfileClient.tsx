...
import { Shield, ShieldCheck, ShieldOff, Key, AlertCircle, CheckCircle2, Copy, Check, User } from "lucide-react";
...
export default function ProfileClient({ user }: ProfileClientProps) {
    ...
    // Track 2FA status locally to avoid reload lag
    ...
    if (confirmState?.success && !twoFAEnabled && setupData) {
        setTwoFAEnabled(true);
        setSetupData(null);
    }

    // After disable2FA succeeds, update local state
    if (disableState?.success && twoFAEnabled) {
        setTwoFAEnabled(false);
    }
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
                <div className="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500">Update your name and primary email address</p>
                    </div>
                </div>
